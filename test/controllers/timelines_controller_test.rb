...
class TimelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post timelines_url, params: { timeline: { end_time: @timeline.end_time, name: @timeline.name, start_time: @timeline.start_time, user_id: @timeline.user_id } }
    end
  ...
  test "should update timeline" do
    patch timeline_url(@timeline), params: { timeline: { end_time: @timeline.end_time, name: @timeline.name, start_time: @timeline.start_time, user_id: @timeline.user_id } }
